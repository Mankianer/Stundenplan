...
class Test(TestCase):
    ...
    def test_get_default_slot_options(self):
        ...
        # test with lists
        list_options = stundenplan.get_default_config()
        ...
        slot_options = stundenplan.get_default_slot_options(list_options)
        ...
        collition_options = stundenplan.get_default_config()
        ...
        slot_options = stundenplan.get_default_slot_options(collition_options)
