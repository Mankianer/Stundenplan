...
class Test(TestCase):
    def test_create_plans_slot_mask(self):
        ...
        tag3 = "Tag 3 - Leer"
        tag4 = "Tag 4 - Lücke"
        plans = mankianerplan.create_plans("test",
                                           slot_mask={tag1: list(range(-1, 6)), tag2: list(range(1, 4)), tag3: [],
                                                      tag4: list(itertools.chain(range(1, 3), range(4, 6)))})
        ...
        self.assertCountEqual([1, 2, 4, 5], plans[0].get_plan()[tag4].keys(),
